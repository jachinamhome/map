        ...
        {isMobile ? (
          <>
            ...
            >
              {/* 리사이저 */}
              <div
                className="w-full h-24 flex items-center justify-center cursor-row-resize sticky top-0 z-50 bg-white"
                onMouseDown={handleResizerMouseDown}
                onTouchStart={handleResizerMouseDown}
              >
                <div className="w-14 h-1.5 bg-gray-200 rounded-full shadow-sm" />
              </div>
